<?php 
  ...
  $listeproduit=$produitc->affiche_produit();
...
<head>
    ...
    <link rel="shortcut icon" href="frontOffice/assets/img/ico/favicon.ico">
    <link rel="apple-touch-icon" sizes="144x144" href="frontOffice/assets/img/ico/apple-touch-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="114x114" href="frontOffice/assets/img/ico/apple-touch-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="72x72" href="frontOffice/assets/img/ico/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon" href="frontOffice/assets/img/ico/apple-touch-icon-57x57.png">

    <title>Kompleet by Distinctive Themes</title>

    <!-- Bootstrap Core CSS -->
    <link href="frontOffice/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="frontOffice/assets/css/animate.css" rel="stylesheet">
    <link href="frontOffice/assets/css/plugins.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="frontOffice/assets/css/style.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="frontOffice/assets/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link href="frontOffice/assets/css/pe-icons.css" rel="stylesheet">
    ...
    <div class="master-wrapper">
        ...
        <div class="preloader">
            <div class="preloader-img">
                <span class="loading-animation animate-flicker"><img src="frontOffice/assets/img/loading.GIF" alt="loading"/></span>
            </div>
        </div>
        ...
        <nav class="navbar navbar-default navbar-fixed-top fadeInDown" data-wow-delay="0.5s">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="pull-right text-right">
                            <ul class="list-inline">
                                <li>
                                    <div><i class="fa fa-envelope-o"></i> workmates@domain.com</div>
                                </li>
                                <li>
            ...
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand smoothie logo logo-light" href="index.html"><img src="frontOffice/assets/img/logo.gif"  height="500" width="90"></a>
                    <a class="navbar-brand smoothie logo logo-dark" href="index.html"><img src="frontOffice/assets/img/logo.gif"  height="500" width="90"></a>
                </div>
        ...
        <header id="headerwrap" class="dark-wrapper backstretched special-max-height no-overlay">
            <div class="container vertical-center">
                <div class="intro-text vertical-center text-left smoothie">
                    <div class="intro-heading wow fadeIn heading-font" data-wow-delay="0.2s">This is WorkMates</div>
                    <div class="intro-sub-heading wow fadeIn secondary-font" data-wow-delay="0.4s">Take a look at our <span class="rotate">Splendid fashion show, exquisite shop items, Fast Delivery</span></div>
                </div>
            </div>
        </header>
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
            ...
            <div class="viewport">
                <div class="widget mb50">
                    ...
                    <div>
                        <div class="media">
                            <div class="pull-left">
                                <img class="widget-img" src="frontOffice/assets/img/widget/widget1.jpg" alt="">
                            </div>
                        ...
                        <div class="media">
                            <div class="pull-left">
                                <img class="widget-img" src="frontOffice/assets/img/widget/widget2.jpg" alt="">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <div class="pull-left">
                                <img class="widget-img" src="frontOffice/assets/img/widget/widget3.jpg" alt="">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <div class="pull-left">
                                <img class="widget-img" src="frontOffice/assets/img/widget/widget4.jpg" alt="">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <div class="pull-left">
                                <img class="widget-img" src="frontOffice/assets/img/widget/widget5.jpg" alt="">
                            </div>
                            <div class="media-body">
    ...
    <script src="frontOffice/assets/js/jquery.js"></script>
    <script src="frontOffice/assets/js/bootstrap.min.js"></script>
    <script src="frontOffice/assets/js/plugins.js"></script>
    <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false"></script>
    <script src="frontOffice/assets/js/init.js"></script>
    ...
    $(document).ready(function() {
        ...
        jQuery('#headerwrap').backstretch([
            "frontOffice/assets/img/bg/bg1.jpg",
            "frontOffice/assets/img/bg/bg2.jpg",
            "frontOffice/assets/img/bg/bg3.jpg"
        ], {
            duration: 8000,
            fade: 500
        });
