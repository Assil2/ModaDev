...
<body id="page-top" class="index">
    ...
    <div class="master-wrapper">
        ...
        <div id="mapwrapper" class="alt-map"></div>
        ...
        <section id="welcome">
            <div class="section-inner nopaddingbottom">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 mb100">
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <form action="ajoutLivraisonAction.php" method="POST">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" id="reference" name="reference" maxlength="10" minlength="3" required>
