          ...
          ?>
                        <div class="body">
                            ...
                            <tr class="tr-shadow">
                                ...
                                <td class="desc"><?PHP echo $row['produit']; ?></td>
                                <td><?PHP echo $row['nomUsr']; ?></td>
                                <td>
                                <?PHP echo $row['prenomUsr']; ?>
                                </td>
                                <td>
                                <?PHP echo $row['email']; ?>
                                </td>
                                ...
                                <td>
                                <form
                                  method="POST" action="supprimerLivraison.php">
                        ...
                        <a href="ModiferLivraison.php?id=<?PHP echo $row['id']; ?>" >
