          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav">
             ...
             <li><a href="#">Digital <span class="caret"></span></a>
              ...
              <li><a href="AgenceLivraison.php">Agence Livraison</a></li>
                    ...
                    <div class="col-md-4 col-sm-4">
                      <article class="aa-blog-content-single">                        
                        ...
                        <figure class="aa-blog-img">
                          <a href="#"><img src="<?php echo $event['img']; ?>" width="300" height="200"  alt="fashion img"></a>
                        </figure>
                        <p><?php echo $event['description']; ?></p>
                        <div class="aa-article-bottom">
                          <div class="aa-post-author">
                            Posted By <a href="#"><?php echo $event['auteur']; ?></a>
                          </div>
                          <br>
                          <div class="aa-post-author">
                            currently <?php echo $nbr; ?> participation
                          </div>
                          <div class="aa-post-date">
                          <?php echo $event['date_ajout']; ?>
                          </div>
                        </div>
                      </article>
                    </div>
